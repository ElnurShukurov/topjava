...
public class MealRestController {
    ...
    public List<MealTo> getFiltered(@Nullable LocalDate startDate, @Nullable LocalTime startTime, @Nullable LocalDate endDate, @Nullable LocalTime endTime) {
        int userId = SecurityUtil.authUserId();
        log.info("getBetween dates({} - {}) and time({} - {}) for user {}", startDate, endDate, startTime, endTime, userId);
        List<Meal> mealsByDate = service.getBetween(startDate, endDate, userId);
